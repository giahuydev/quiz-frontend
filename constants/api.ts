...
export const ENDPOINTS = {
  ...
  SESSIONS: {
    BASE:          '/exam-sessions',
    JOIN:          '/exam-sessions/join',
    BY_ID:         (id: number) => `/exam-sessions/${id}`,
    WAITING:       (id: number) => `/exam-sessions/${id}/waiting`,
    START_ATTEMPT: (id: number) => `/exam-sessions/${id}/start-attempt`,
    RESULTS:       (id: number) => `/exam-sessions/${id}/results`,
  },
  RESULTS: {
    BY_ID:  (id: number) => `/exam-results/${id}`,
    SUBMIT: (id: number) => `/exam-results/${id}/submit`,
    REVIEW: (id: number) => `/exam-results/${id}/review`,
  },
};
