// File: quiz-frontend/app/(dashboard)/student/profile/page.tsx
'use client';
  ...
  return (
    <div className="max-w-md space-y-6">
      <div className="p-4 border border-gray-100 rounded-md bg-white">
        <h2 className="text-[10px] font-bold text-gray-400 uppercase tracking-widest border-b pb-2 mb-4">Hồ sơ sinh viên</h2>
        <div className="grid grid-cols-2 gap-4">
          {[['Họ tên', user?.name], ['Email', user?.email], ['Vai trò', 'Sinh viên']].map(([l, v]) => (
